...
export class FacetChart
    ...
    /**
     * Holds the provisional render properties for chart views, as well as the provisional chart
     * views themselves.
     *
     ...
     * instances, without rendering them. In a later method, we use those provisional chart views to
     ...
     */
    @computed get provisionalPlacedSeries(): ProvisionalPlacedFacetSeries[] {
    ...
    @computed get placedSeries(): PlacedFacetSeries[] {
        ...
        if (uniformXAxis) {
            const [min, max] = extent(
                excludeUndefined(
                    flatten(
                        this.provisionalPlacedSeries.map(
        ...
        return this.provisionalPlacedSeries.map((series) => ({
            ...series,
            manager: {
                ...series.manager,
                xAxisConfig: {
